 ...
 flowchart TD                                                                                                                                       
      ...
      T1[tier1_credit] --> C1[/Credits endpoint/] --> C2[/Credit-to-USD rate/] --> C3[/Discount rate/] --> C4{Multiple token pools}
      C4 --> |Yes| C5[/Pool field + label, repeat/] --> Review
      C4 --> |No| Review

      T2[tier2_structured] --> B1[/Root data key/] --> B2[/Line type field/] --> B3[/Resource ID template/] --> Review

      T3a[tier3_enterprise CSV] --> E1[/Header rows to skip/] --> E2[/Date format/] --> E3[/Cost categories, repeat/] --> E4{Aggregation}
      E4 --> |daily| Review
      E4 --> |monthly| Review
      E4 --> |none| Review

      T3b[tier3_enterprise API] --> N1[nested_response = true] --> N2{Aggregation}
      N2 --> |daily| Review
      N2 --> |monthly| Review
      N2 --> |none| Review
